...
export default function Personal() {
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            const res = await axios("/product/profile/" + username)
    ...
    useEffect (() => {
        ...
        const fetchProducts = async () => {
            const res = await axios("/product/profile/liked/" + userId)
    ...
    <div className='container'>
        ...
        <div className={styles.personal}>
            <div className={styles.wrapper}>
                <img className={styles.imgBackground} src={user.coverAvatar} alt="" />
